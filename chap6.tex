...
\includegraphics[width=8cm]{./rd53a_SCC.png}
...
\begin{figure}[h]\centering
  \begin{minipage}{0.5\hsize}
    \includegraphics[width=7cm]{./temp_circit.png}
  \end{minipage}
  \begin{minipage}{0.4\hsize}
    \includegraphics[width=5cm]{./temp_circit_pic.png}
  \end{minipage}
...
\begin{figure}[h]\centering
\includegraphics[width=6cm]{./power_supply.png}
...
\begin{figure}[htbp]
 \begin{minipage}{0.5\hsize}
  \begin{center}
   \includegraphics[width=60mm]{./fpga_board.png}
  \end{center}
