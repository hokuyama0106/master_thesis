...
\begin{figure}[bpt]\centering
\includegraphics[width=15cm]{demo_monitor_dcs}
...
\begin{figure}[bpt]\centering
\includegraphics[width=13cm]{demo_search_function}
...
\begin{figure}[bpt]\centering
  ...
  \begin{minipage}{0.45\hsize}
    \begin{center}
    \includegraphics[width=70mm]{demo_view_dcs.pdf}
    \end{center}
  \end{minipage}
