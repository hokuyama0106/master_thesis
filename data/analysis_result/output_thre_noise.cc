{
  ...
  std::string branch = "MODULEWIREBONDING_std_thresholdscan_1_NoiseMap_0";
  Int_t col;
  Float_t val;
  ...
  std::unique_ptr<TH1F> hist( new TH1F( "", ";Noise[e];# of pixels", max, 1 ,max+1 ) );
  ...
  hist -> Draw("hist");
  f->Draw("SAME");
  c1->SaveAs( "Threshold_noise_dist.png" ); 
}
