...
中央データベースにおける組み立て工程と対応する品質試験項目のデータ構造を表\ref{pd_stage_structure}に示す。
...
\clearpage
\subsection{データベース同期ツール} \label{sec:interfacing_tool}
...
\begin{itemize}
  ...
  \item 読み出し試験結果検索機能
  \item 節\ref{sec:interfacing_tool}で述べたデータベース同期ツール
\end{itemize}
...
\includegraphics[width=13cm]{viewer_comment}
...
\begin{figure}[bpt]\centering
\includegraphics[width=13cm]{viewer_tag}
