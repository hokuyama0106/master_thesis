...
また、モジュールの配置も品質を考慮して決定する。例として$|\eta|$が大きく、通過粒子密度が多い領域には不良ピクセルが少ないモジュールを搭載するといった位置決定がなされる。
...
\includegraphics[width=12cm]{localdb_overview}
...
\begin{figure}[bpt]\centering
\includegraphics[width=12cm]{localdb_structure_detail}
...
\begin{figure}[bpt]\centering
\includegraphics[width=15cm]{demo_view_scan_result}
...
\includegraphics[width=12cm]{pd_module_structure}
...
\begin{figure}[bpt]\centering
\includegraphics[width=14cm]{webapp_sign_off}
...
\begin{figure}[bpt]\centering
\includegraphics[width=10.5cm]{webapp_search_function}
