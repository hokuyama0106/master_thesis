...
それぞれの情報の詳細について表\ref{download_information}に示す。

\begin{table}[tbp]
\begin{center}
\caption[ダウンロードする情報]{ダウンロードする情報}
\label{download_information}
  \begin{tabular}{|ll|} \hline
    ...
    モジュール & シリアルナンバー \\ 
     ...
     & 搭載FEチップの枚数  \\ \hline 
    FEチップ & シリアルナンバー \\
     & FEチップID(モジュール上の位置を表す情報) \\ \hline 
     & 登録機関 \\ \hline 
  \end{tabular}
\end{center}
\end{table}

ダウンロードされたモジュール、FEチップのドキュメントの例を以下に示す。
...
\caption[登録したKEKモジュールのシリアルナンバー]{登録したKEKモジュールのシリアルナンバー}
...
\caption[モジュール及び構成部品情報取得のイメージ]{モジュール及び構成部品情報取得のイメージ}
...
\begin{table}[tbp]
\begin{center}
\caption[ダウンロード処理時間詳細]{ダウンロード処理時間詳細}
