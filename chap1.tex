...
\subsection{ヒッグス機構}
ここでは標準模型において素粒子の質量獲得の理由となるヒッグス機構について説明する。
...
\begin{itemize}
  ...
  \item 検出器の細密化.\\
  1バンチ交叉あたりの反応数(\textbf{パイルアップ})が表\ref{compare_lhc}より約5倍になる。これらの衝突点を区別するためにはより細密な検出器を使用する必要がある。図\ref{detector_posi_res}にイメージを示す。
\end{itemize}
